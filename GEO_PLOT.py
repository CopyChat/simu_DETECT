...
def get_1D_da_in_classif_df(da: xr.DataArray, classif: pd.DataFrame):
    """
    merge classif and 1d data, return df
    Args:
        da ():
        classif ():
    ...
    list_class = list(set(classif['class'].to_list())) * b.shape[0]
